...
class Trainer(object):
    def __init__(self,
        ...
        self.d_optimizer = optimize.optimize_loss(
        ...
        self.g_optimizer = optimize.optimize_loss(
        ...
        #self.session = tfdbg.LocalCLIDebugWrapperSession(self.session)
